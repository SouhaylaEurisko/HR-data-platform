...
_LLM_SYSTEM_PROMPT = """You are an expert at mapping messy Excel column headers to database column names for an HR platform.
...
async def _llm_suggest_mappings(
    ...
    response = await call_llm(_LLM_SYSTEM_PROMPT, user_msg)
